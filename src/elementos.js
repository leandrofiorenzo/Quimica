export function obtenerElemento(periodo, indice) {
    let numeroAtomico = matrizNumerosAtomicos[periodo - 1][indice - 1];
    if(numeroAtomico == null) return null
    return elementos.find(e => e.number == numeroAtomico);
}
